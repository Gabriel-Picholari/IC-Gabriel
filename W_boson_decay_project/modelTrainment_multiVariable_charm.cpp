...
void modelTrainment_multiVariable_charm(const char *fileName) 
{
    TFile* outputFile = TFile::Open("TMVAOutput_multiVariable_charm.root", "RECREATE");
    ...
    TMVA::DataLoader loader("dataset_c_multiVariable");
