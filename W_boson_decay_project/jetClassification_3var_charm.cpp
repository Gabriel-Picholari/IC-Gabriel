...
void jetClassification_3var_charm(const char* fileName)
{
    ...
    TCanvas *c1 = new TCanvas("c1", "Charmed-jet classifier: nRho distributions", 2500, 2500);
    c1->Divide(3, 2);

    // Signal (upper bound = 1, 1.5, 2)
    c1->cd(1);
    first_signal_nRho_Distribution->SetTitle("Charmed signal jets: nRho distribution (upper bound = 1)");
    ...
    c1->cd(2);
    second_signal_nRho_Distribution->SetTitle("Charmed signal jets: nRho distribution (upper bound = 1.5)");
    ...
    c1->cd(3);
    third_signal_nRho_Distribution->SetTitle("Charmed signal jets: nRho distribution (upper bound = 2)");
    ...
    c1->cd(4);
    first_background_nRho_Distribution->SetTitle("Charmed background jets: nRho distribution (upper bound = 1)");
    ...
    c1->cd(5);
    second_background_nRho_Distribution->SetTitle("Charmed background jets: nRho distribution (upper bound = 1.5)");
    ...
    c1->cd(6);
    third_background_nRho_Distribution->SetTitle("Charmed background jets: nRho distribution (upper bound = 2)");
    ...
    c2->cd(1);
    signal_pTDistribution->SetTitle("Charmed signal jets: p_{T} distribution");
    ...
    c2->cd(2);
    background_pTDistribution->SetTitle("Charmed background jets: p_{T} distribution");
    ...
    c3->cd(1);
    signal_nConstDistribution->SetTitle("Charmed signal jets: number of constituents distribution");
    ...
    c3->cd(2);
    background_nConstDistribution->SetTitle("Charmed background jets: number of constituents distribution");
